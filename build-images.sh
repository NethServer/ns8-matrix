...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:18.4-alpine ghcr.io/element-hq/synapse:v1.149.1 ghcr.io/element-hq/element-web:v1.12.12 ghcr.io/cinnyapp/cinny:v4.11.1 ghcr.io/nethesis/matrix2acrobits:0.0.4" \
    "${container}"
# Commit the image
